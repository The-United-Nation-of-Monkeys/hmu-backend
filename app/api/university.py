...
from app.schemas.grant import GrantResponse, GrantDetailResponse, GrantAssignRequest, GrantDetailWithItemsResponse
...
async def get_grant(
    ...
    """Получение гранта с spending items и requests"""
    import logging
